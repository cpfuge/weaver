 ...
 *
 * This value is used by the RCC HAL module to compute the I2S1 clock source frequency.
 */
 ...
 *
 * This value is used by the RCC HAL module to compute the I2S2 clock source frequency.
 */
...
/**
 * @brief CRYP peripheral configuration
 */
#define USE_HAL_CRYP_SUSPEND_RESUME 1U

/**
 * @brief Assert selection
 *
